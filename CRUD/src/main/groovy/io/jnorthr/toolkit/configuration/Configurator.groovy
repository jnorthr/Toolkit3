...
package io.jnorthr.toolkit.configuration;
import groovy.json.*
...
public class Configurator{
    ...
    /*
     * Asks configure to return current value of given key
     */
    ...
    /*
     * Asks configure to return current value of the input path
     */
    public getInputPath()
    {
		ck.getInput('path');
    ...
    /*
     * Asks configure to return current value of the input file
     */
    public getInputFile()
    {
		ck.getInput('file')
    ...
    /*
     * Asks configure to return current value of the input full filename
     */
    ...
    /*
     * Asks configure to return current value of the output path
     */
    ...
    /*
     * Asks configure to return current value of the output file
     */
    ...
    /*
     * Asks configure to return current value of the output full filename
     */
    ...
    /*
     * Asks configure to store current value for given key
     */
